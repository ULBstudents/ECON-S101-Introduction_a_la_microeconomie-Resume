...
\fancyfoot[L]{Open source pour ajout ou modification: https://github.com/Rodriguevb/ECON-S101-Introduction\_a\_la\_microeconomie-Resume} % Numéro de page en bas de page à gauche
...
\pdfinfo{
    ...
    /Creator  (https://github.com/Rodriguevb/ECON-S101-Introduction_a_la_microeconomie-Resume/)
}
...
% Titre du PDF
\title{ECON-S101 - Introduction à la microéconomie\\Micael \textsc{Castanheira De Moura}\\Résumé du cours}

\pdfinfo{
/Title(ECON-S101 - Introduction à la microéconomie - Résumé du cours)
}
